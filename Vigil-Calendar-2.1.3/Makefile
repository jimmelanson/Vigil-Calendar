...
DISTVNAME = Vigil-Calendar-2.1.3
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "version: v2.1.3" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"version\" : \"v2.1.3\"," >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"Vigil-Calendar\" VERSION=\"2.1.3\">" > Vigil-Calendar.ppd
